...
```
Note that a significant population of Texans leave for a foreign counties, from 1990s to 2010. Also note that, in 2006, there is a spike in Texans moving to Louisiana.
