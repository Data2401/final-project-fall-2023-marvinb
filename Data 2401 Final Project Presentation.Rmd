...
ggplot(allCA, aes(x = Y1, y = Percent_Migration, fill = State)) + geom_col() +  scale_y_log10() +  theme_bw(base_size = 8) + labs(y= "Percent Population", x = "Year") +  coord_flip() #+ coord_cartesian(ylim = c(97, NA)) 
```
