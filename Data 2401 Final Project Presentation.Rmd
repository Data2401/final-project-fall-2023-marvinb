...
ggplot(n1_CATXdata, aes(Year, y = Average_Household_Income, group = 3)) + geom_line(color = "dodgerblue3") + theme_bw() + labs(y = "Average Household Income")
```
## Applying Inflation Correction (in 2022 dollars)
...
ggplot(new_AHIdata, aes(Year, y = Average_Household_Income, group = 3)) + geom_line(color = "dodgerblue3") + theme_bw() + labs(y = "Average Household Income") + geom_line(aes(y=Adjusted_in_2022dollars), color = "gold2")
```
...
#ggplot(allCA, aes(x = Y1, y = Percent_Migration, fill = State)) + geom_col() #+  scale_y_log10() +  theme_bw(base_size = 8) + labs(y= "Percent Population", x = "Year") + coord_cartesian(ylim = c(97, NA)) 
```
